<div id="sidebar" class="fl-left">
    <ul id="sidebar-menu">
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="/admin/pages/add" title="" class="nav-link">Thêm mới</a>
                </li>
                <li class="nav-item">
                    <a href="/admin/pages/list" title="" class="nav-link">Danh sách các trang</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="/admin/posts/add" title="" class="nav-link">Thêm mới</a>
                </li>
                <li class="nav-item">
                    <a href="/admin/posts/list" title="" class="nav-link">Danh sách bài viết</a>
                </li>
                <li class="nav-item">
                    <a href="/admin/post_cat/list" title="" class="nav-link">Danh mục bài viết</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="/admin/products/add" title="" class="nav-link">Thêm mới</a>
                </li>
                <li class="nav-item">
                    <a href="/admin/products/list" title="" class="nav-link">Danh sách sản phẩm</a>
                </li>
                <li class="nav-item">
                    <a href="/admin/product_cat/list" title="" class="nav-link">Danh mục sản phẩm</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="/admin/sliders/add" title="" class="nav-link">Thêm mới</a>
                </li>
                <li class="nav-item">
                    <a href="/admin/sliders/list" title="" class="nav-link">Danh sách slider</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
